...
/// <summary>
/// Funkcja do obsługi sterowania myszką na ekranie menu
/// </summary>
...
/// <summary>
/// Funkcja do obsługi sterowania myszką na ekranie pomocy
/// </summary>
/// <param name="event">zdarzenie</param>
...
/// <summary>
/// Funkcja do obsługi sterowania myszką na ekranie rankingu
/// </summary>
/// <param name="event">zdarzenie</param>
...
/// <summary>
/// Funkcja do obsługi sterowania myszką na ekranie wyboru poziomu trudności
/// </summary>
/// <param name="event">zdarzenie</param>
...
/// <summary>
/// Funkcja do obsługi sterowania myszką na ekranie gry
/// </summary>
/// <param name="event">zdarzenie</param>
...
/// <summary>
/// Funkcja do obsługi sterowania na ekranie końca gry.
/// </summary>
/// <param name="event">zdarzenie</param>
/// <param name="trudnosc">zmienna przechowująca poziom trudności</param>
