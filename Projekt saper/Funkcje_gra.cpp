...
void wczytaj_ranking_z_pliku(const char* filename, Ranking* ranking) {
    if (ranking == NULL) {
        fprintf(stderr, u8"Wskaźnik na ranking jest równy NULL\n");
        return;
    }
